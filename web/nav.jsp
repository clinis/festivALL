      ...
      <a class="navbar-brand hidden-xs hidden-sm" href="index.jsp">festivALL - all the festivals!</a>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
                ...
                <li class="${pageContext.request.servletPath eq '/gest.jsp' ? ' active' : ''}"><a href="gest.jsp">Manage Bands</a></li>
				<li class="${pageContext.request.servletPath eq '/list-bands.jsp' ? ' active' : ''}"><a href="list-bands.jsp">Bands List</a></li>
                <li class="${pageContext.request.servletPath eq '/add-bands.jsp' ? ' active' : ''}"><a href="add-bands.jsp">Add Bands</a></li>
			</ul>
		</div><!-- /.navbar-collapse -->
	</div><!-- /.container -->
</nav>
